...
from .common import *
from .objectintrospect import getlogoattr, update_logo_attrs
# import imp
import threading
...
class Interpreter(object):
    ...
    def expr(self):
        ...
        try:
            ...
            raise LogoError(newExc).with_traceback(exc_info[2])
        return val
    ...
    def import_function(self, import_function, names=None):
        ...
        """
        if isinstance(import_function, (type, type)):
...
def arity(func):
    ...
    if hasattr(func, 'im_func'):
        ...
        offset = -1
    try:
        # Python 3.11+: getargspec is removed, use getfullargspec
